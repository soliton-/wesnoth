...
public:
	...
	std::string alignment_str() const { return alignment_ ? unit_alignments::get_string(*alignment()) : ""; }
	/** Returns alignment specified by alignment() for filtering when exist, else return unit alignment.
	 */
	std::string alignment_filtering() const;
